...
#
# By default the Codex agent and the Feishu/Lark platform are included. To
# explicitly select the Codex agent, set AGENTS:
#
#   make build AGENTS=codex
#
# Platform selection is retained for compatibility, but this trimmed tree only
# contains the Feishu/Lark platform:
#
